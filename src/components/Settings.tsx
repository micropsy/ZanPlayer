...
import { Languages, Settings as SettingsIcon, CheckCircle2, Info, Download, Trash2, Loader2 } from "lucide-react";
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
              useLocalWhisper ? "bg-blue-600" : theme === 'dark' ? "bg-gray-700" : "bg-gray-300"
            }`}
          >
            <span
